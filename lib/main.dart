...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<Map<String, String>> emergencySounds = [
    {'label': 'Inicio', 'file': 'Inicio.mp4'},
    {'label': 'Ingresa', 'file': 'Ingresa.PNG'},
    {'label': 'Nosotros', 'file': 'Nosotros.PNG'},
    {'label': 'Contactanos', 'file': 'Contactanos.PNG'},
    {'label': 'Campo', 'file': 'Campo.mp3'},
  ];
